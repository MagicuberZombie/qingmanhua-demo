 ...
 */
public class TopicCollectionData {
    private String id;
    private String is_show;
    private String topic_name;
    private String topic_pic_url;
    private List<String> topic_tag_name;
    private String type;

    public TopicCollectionData() {
    }

    public TopicCollectionData(String id, String is_show, String topic_name, String topic_pic_url, List<String> topic_tag_name, String type) {
        this.id = id;
    ...
    public List<String> getTopic_tag_name() {
        return topic_tag_name;
    }

    public void setTopic_tag_name(List<String> topic_tag_name) {
        this.topic_tag_name = topic_tag_name;
    }
